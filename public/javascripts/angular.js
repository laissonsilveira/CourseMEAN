        ...
        this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
            function( $rootScope,   $browser,   $sniffer,   $rootElement) {
                ...
                $rootElement.on('click', function(event) {
                    ...
                    // Ignore when url is started with javascripts: or mailto:
 ...
 *  });
     ...
     * one to execute arbitrary javascripts by the use of the expression() syntax.  Refer
...
// service.
     ...
     *   http://james.padolsey.com/javascripts/parsing-urls-with-the-dom/
     *
     * @kind function
...
// so that they are not executed in an inconsistent state.
     ...
     * [prototypal inheritance](https://github.com/angular/angular.js/wiki/Understanding-Scopes#javascripts-prototypal-inheritance).
     * An important implication of this is if `ngModel` is used within `ngIf` to bind to
     * a javascripts primitive defined in the parent scope. In this case any modifications made to the
